   ...
   protected void doFilterInternal(HttpServletRequest request,
       ...
       if (header != null && header.startsWith("Bearer ")) {
           ...
           try {
               ...
               response.setHeader("Token-Status", "malformed");
           } catch (UnsupportedJwtException e) {
               response.setHeader("Token-Status", "unsupported");
           } catch (SignatureException e) {
               response.setHeader("Token-Status", "invalid-signature");
           } catch (IllegalArgumentException e) {
               response.setHeader("Token-Status", "invalid");
           } catch (Exception e) {
               response.setHeader("Token-Status", "error");
           }
       }
